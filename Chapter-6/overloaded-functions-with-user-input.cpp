...
// the gross pay of hourly paid or salaried employees.
//
...
int main()
{
  ...
  // Display the menu and get a selections.
...
// This function calculates the gorss weekly pay of         *
